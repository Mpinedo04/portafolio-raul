  ...
  fields: [
...

    {
      ...
      fields: [
        ...
        { name: 'backgroundColor', title: 'Color de Fondo Global (Web)', type: 'color', description: 'Color base que se verá en toda la web satisfactoriamente.' },
        { name: 'navBackgroundColor', title: 'Color de Fondo Navegación (Header / Footer)', type: 'color', description: 'Color independiente para la cabecera y el pie de página satisfactoriamente.' },
        { 
          name: 'glassBlur', 
