export default {
  ...
  fields: [
    ...
    {
      name: 'portfolioTitle',
      title: 'Título Página Hub Proyectos',
      type: 'string',
      group: 'pages',
    ...
    },
    {
      ...
      title: 'Subtítulo Hub Proyectos',
      type: 'string',
      group: 'pages',
      initialValue: 'Selecciona una categoría para explorar mi trayectoria creativa.',
    },
    {
    ...
    {
      name: 'propiosTitle',
      title: 'Título Página Proyectos Propios',
      type: 'string',
      group: 'pages',
      initialValue: 'PROYECTOS PROPIOS',
    },
    {
      name: 'propiosSubtitle',
      title: 'Subtítulo Proyectos Propios',
      type: 'string',
      group: 'pages',
      initialValue: 'Cortometrajes, estudios y experimentación personal.',
    },
    {
      name: 'propiosBanner',
    ...
    {
      name: 'externosTitle',
      title: 'Título Página Trabajos Externos',
      type: 'string',
      group: 'pages',
      initialValue: 'TRABAJOS EXTERNOS',
    },
    {
      name: 'externosSubtitle',
      title: 'Subtítulo Trabajos Externos',
      type: 'string',
      group: 'pages',
      initialValue: 'Clientes, empresas y proyectos producidos para terceros.',
    },
    {
      name: 'externosBanner',
